...
const Profile = () => {
    ...
    const { _id, firstname, lastname, email, phone } = editState

    const handleSubmit = async (e) => {
        e.preventDefault()
        dispatch({ type: "NOTIFY", payload: { loading: true } });
        await postData("auth/editProfile", { _id: _id, email: email, phone: phone, firstname: firstname, lastname: lastname })
                            ...
                            <fieldset>
                                ...
                                <div className="form-group required">
                                    ...
                                    <div className="col-sm-10">
                                        <input type="text" name="firstname" value={firstname} placeholder="First Name" id="input-firstname" className="form-control" onChange={handleChangeInput} />
                                    </div>
                                </div>
                                <div className="form-group required">
                                    <label className="col-sm-2 control-label" htmlFor="input-lastname">Last Name</label>
                                    <div className="col-sm-10">
                                        <input type="text" name="lastname" value={lastname} placeholder="Last Name" id="input-lastname" className="form-control" onChange={handleChangeInput} />
                                    </div>
                                </div>
                                <div className="form-group required">
                                    <label className="col-sm-2 control-label" htmlFor="input-email">E-Mail</label>
                                    <div className="col-sm-10">
                                        <input type="email" name="email" value={email} placeholder="E-Mail" id="input-email" className="form-control" onChange={handleChangeInput} />
                                    </div>
                                </div>
                                <div className="form-group required">
                                    <label className="col-sm-2 control-label" htmlFor="input-telephone">Telephone</label>
                                    <div className="col-sm-10">
                                        <input type="tel" name="phone" value={phone} placeholder="Telephone" id="input-telephone" className="form-control" onChange={handleChangeInput} />
                                    </div>
                                </div>
                            </fieldset>
                            <div className="buttons clearfix">
                                <div className="pull-left"><a href="/login" className="btn btn-primary">Back</a></div>
